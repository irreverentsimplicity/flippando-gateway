...
const FLIPCHAIN_RPC_URL="https://flippandomainnet-2737273595554000-1.jsonrpc.sagarpc.io"
...
const FLIPND_FLIPCHAIN="0x4c6886B1a5b717Aa567D5F51332934fA0422eC48"
...
const FLIPBB_FLIPCHAIN="0x6892149654c4746Ae04A3e3eD853248BC9003544"
...
const FLIPAG_FLIPCHAIN="0xAac74A62a5AfE51E6885A32f9f5af7617C9Cf838"
    ...
    try {
        const results = await Promise.all(
            Object.entries(providers).map(async ([chain, provider]) => {
                const formattedChain = chain === 'flipchain' ? 'Flipchain' : chain.charAt(0).toUpperCase() + chain.slice(1);
